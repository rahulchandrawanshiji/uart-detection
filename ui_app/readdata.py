...
requst_cmd = queue.Queue()

def read_from_ports(hardware_port, android_port):
    print(f"Reading from {hardware_port.port} and {android_port.port}...")
...
if __name__ == "__main__":
    try:
        ...
        threading.Thread(target=read_from_ports, args=(hardware_port,android_port), daemon=True).start()
